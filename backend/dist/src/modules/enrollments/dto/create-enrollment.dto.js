...
class CreateEnrollmentDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { studentId: { required: true, type: () => String }, courseId: { required: true, type: () => String } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsUUID)('4', { message: 'معرف الطالب غير صالح' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'معرف الطالب مطلوب' }),
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'معرف الدورة مطلوب' }),
    __metadata("design:type", String)
